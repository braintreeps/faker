...
class Provider(PersonProvider):
    ...
    first_names_male = (
        ...
        'Hans-Henning',  'Hans-Hermann', 'Hans-Hinrich',
        ...
        'Helmuth', 'Hendrik', 'Henner', 'Henning', 'Henrik', 'Henry', 'Henryk',
         'Heribert', 'Hermann', 'Hermann Josef', 'Hermann-Josef',
    ...
    first_names_female = (
        'Adele',  'Adelheid', 'Adelinde', 'Adeline', 'Adina',
        ...
        'Alwina',  'Amalia', 'Amalie', 'Amanda', 'Amelie', 'Ana',
        ...
        'Ayten',   'Barbara', 'Beata', 'Beate', 'Beatrice',
        ...
        'Elisa',   'Elise',  'Elke', 'Ella',
        'Ellen', 'Elli', 'Ellinor', 'Elly', 'Elma', 'Elsa',  'Else',
        ...
        'Grit', 'Gudrun', 'Gudula',    
         'Gusti', 'Gönül', 'Gülay', 'Gülsen', 'Gülten', 'Halina',
        ...
        'Hertha', 'Hilda', 'Hildburg', 'Hilde', 'Hildegard', 'Hildegart',
          'Hilma', 'Hiltraud', 'Hiltrud', 'Hubertine',
        ...
        'Kristiane', 'Kristin', 'Kristina', 'Kristine', 'Krystyna', 
        ...
        'Lidwina', 'Liesa',  'Lieschen', 'Liesel', 'Lieselotte',
        'Lili', 'Lilian', 'Liliana', 'Liliane', 'Lilija', 'Lilli', 'Lilly',
        'Lilo', 'Lina', 'Linda', 'Lioba', 'Lisa',  'Liselotte',
    ...
    last_names = (
        ...
        'Bauer', 'Baum', 'Becker', 'Beckmann',  'Beier', 'Bender',
        ...
        'Gorlitz', 'Gotthard', 'Graf', 'Grein Groth', 'Gröttner', 'Gude',
         'Gumprich', 'Gute', 'Gutknecht', 'Haase', 'Haering', 'Hänel',
        ...
        'Losekann', 'Löwer', 'Lübs', 'Mälzer',  'Mans', 'Margraf',
        ...
        'van der Dussen', 'Vogt', 'Vollbrecht',  'Wagner', 'Wähner',
