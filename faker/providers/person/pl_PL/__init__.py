...
class Provider(PersonProvider):
    ...
    unisex_last_names = (
        ...
        'Garczarek', 'Dorociak', 'Boguta',  'Widuch', 'Wawrzynek', 'Szymajda', 'Stanaszek',
        ...
        'Leszczyk', 'Kolanek', 'Fijak', 'Furgała', 'Faruga', 'Poleszak', 'Kusek', 'Herok', 
        'Rymarz', 'Pociask', 'Kowalak', 'Czupryna', 'Trzcionka', 'Sulik', 'Matulka', 
        ...
        'Wołos', 'Wacławczyk', 'Ochnik', 'Maruszczak', 'Lesner', 'Kuncewicz', 'Kieszek', 
        ...
        'Potyrała', 'Pacholak',  'Grzenia', 'Giezek', 'Gajowiak', 'Filak', 'Fechner',
        ...
        'Dylik', 'Cal', 'Buszko', 'Burnat', 'Wyskiel',  'Wiertelak', 'Wiak', 'Roś',
        ...
        'Gąsienica', 'Gabryszak', 'Częścik', 'Cisoń', 'Zmyślony', 'Komisarek', 'Ficoń', 'Citko',
         'Bas', 'Żabierek', 'Wyciszkiewicz', 'Tarach', 'Staniewicz', 'Reichel',
