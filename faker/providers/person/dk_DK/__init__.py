...
class Provider(PersonProvider):
    ...
    first_names_male = (
        ...
        'Frederik', 'Frode', 'Georg ', 'George', 'Gert', 'Gorm', 
         'Gustav', 'Hans', 'Helge', 'Henrik', 'Henry', 
    ...
    first_names_female = (
        ...
        'Berta',   'Birgit', 'Birgitte', 'Birte', 'Birthe',
